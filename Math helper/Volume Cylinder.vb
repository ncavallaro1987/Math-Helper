...
Public Class Volume_Cylinder
    ...
    Public Overrides Sub CalulateButton_Click(sender As Object, e As EventArgs)
        ...
        Try
            ...
            Try
                ...
                'set value of volume
                VolumeDouble = (BaseAreaDouble * HeightDouble)

                'populate volume text box
                VolumeTextBox.Text = VolumeDouble.ToString()

                'populate formula text box
                FormulaTextBox.Text = "( " & BaseAreaDouble & " * " & HeightDouble & " ) =  " & VolumeDouble
    ...
    Private Sub Volume_Cylinder_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        'dont allow validation to prevent closing
        e.Cancel = False
    End Sub

    Private Sub Volume_Cylinder_Load(sender As Object, e As EventArgs) Handles Me.Load
        'display the picture
